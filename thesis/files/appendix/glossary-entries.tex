...
\newglossaryentry{serverlessg}{
    ...
    text=serverless,
    sort=serverless,
    description={Per serverless si intende ...}
}
...
\newglossaryentry{biasg}{
    ...
    text=bias,
    sort=bias,
    description={Nell'ambito del machine learning per bias si intende ...}
}
...
\newglossaryentry{activelearningg}{
    ...
    description={Nell'ambito del machine learning per active learning si intende ...}
}
...
\newglossaryentry{bucketg}{
    ...
    text=bucket,
    sort=bucket,
    description={Nel contesto di AWS, per bucket si intende ...}
}
